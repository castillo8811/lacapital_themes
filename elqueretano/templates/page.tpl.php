    ...
    <div id="page">
        <div id="header-wrapper">
            <header class="tacenter prelative">
                <div id="top">
                    <div id="ciudad-mobil">
                        <select id="change-ciudad-mobil">
                            <option value="cdmx">
                                Ciudad de México
                            </option>
                            <option value="queretaro" selected>
                                Querétaro
                            </option>
                            <option value="edomex">
                                Estado de México
                        ...
                        <div class="menuFixed-social">
                            <ul>
                                <li class="col-4 bsbb left pt5">
                                    <a href="https://www.facebook.com/ElQueretanoSemanal" class="icn-fb-color" target="_blank"></a>
                                </li>
                                <li class="col-4 bsbb left pt5">
                                    <a href="https://twitter.com/ElQueretano_" class="icn-tw-color" target="_blank"></a>
                                </li>
                                <li class="col-4 bsbb left pt5">
                                    <a href="http://youtube.com/channel/ElQueretano_" class="icn-yt-color" target="_blank"></a>
                                </li>
                                <li class="col-4 bsbb left pt5">
                                    <a href="https://www.instagram.com/ElQueretano_" class="icn-insta-color" target="_blank"></a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="menuFixedRevista prelative">
                                ...
                                <div class="download-seccion">
                                    ...
                                    <div class="download-section">
                                        ...
                                        <span class="revista-sub">EL QUERETANO</span>
        ...
        <div id="pageContent">
            ...
            <div class="tacenter pal10" id="super-banner-top">
                    <a href="<?php print 'http://www.lacapitalmx.com/queretaro/trafico/uso-marcos-aguilar-helicoptero-de-la-policia-como-taxi-pr'//print $super["url"]?>" target="_blank">
