    ...
    <div id="page">
                        ...
                        <div class="menuFixed-social">
                            <ul>
                                <li class="col-4 bsbb left pt5">
                                    <a href="https://www.facebook.com/MexiquenseSemanal" class="icn-fb-color" target="_blank"></a>
                                </li>
                                <li class="col-4 bsbb left pt5">
                                    <a href="https://twitter.com/ElMexiquense_" class="icn-tw-color" target="_blank"></a>
                                </li>
                                <li class="col-4 bsbb left pt5">
                                    <a href="https://www.instagram.com/el.mexiquense/" class="icn-insta-color" target="_blank"></a>
                                </li>
                            </ul>
                        </div>
        ...
        <div id="pageContent">
            ...
            <div class="tacenter pal10" id="super-banner-top">
                        <a href="<?php print 'http://www.lacapitalmx.com/subterraneo/dignifican-el-gran-corredor-bursatil'//print $super["url"]?>" target="_blank">
