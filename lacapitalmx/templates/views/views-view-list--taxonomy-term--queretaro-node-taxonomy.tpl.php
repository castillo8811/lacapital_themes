<section id="canalList" class="">
    <h2 itemprop="category" class="U24r0 upper tacenter">Más <?php echo $view->result[0]->field_field_categoria[0]['raw']['taxonomy_term']->name?></h2>
                ...
                <li class="bsbb col-3 pall15 left">
                    <article itemscope itemtype="http://schema.org/NewsArticle">
                        ...
                        <h1 itemprop="headline" class="mtb10">
                            <a href="<?php url('node/' . $v->nid, array('absolute' => true))  ?>" class="O25r0"><?php echo $v->node_title ?></a>
                        </h1>
                    </article>
                </li>
                <?php if($idx==3):?>
