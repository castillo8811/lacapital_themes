...
<section id="canalList" class="">
    <div id="capiruchaWrapper" class="tacenter mb20">
        ...
        <h2 itemprop="category" class="U24r0 upper">Capirucha</h2>
    </div>
    <div class="capiruchaMain tacenter mb30">
                ...
                <?php foreach ($item as $idx => $v):
                    ...
                    <li class="col-3 bsbb pl10 mt30 pr5 mb20 left">
                        <article itemscope itemtype="http://schema.org/NewsArticle">
                            ...
                            <h1 itemprop="headline" class="mtb10 O25r0 tacenter">La Capirucha</h1>
