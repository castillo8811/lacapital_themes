<?php
    $items=get_view_array("home_capital","trafico","home_y_canales");
    $items_sensorama=array_slice($items,0,5);
?>

<section id="sensorama" class="mtb30">
    <div class="titleBig prelative">
        <span class="bg-dotted">
            <span>Tráfico</span>
        </span>
        <a href="/trafico"><h1 itemprop="headline" class="icn-transito mb10"></h1></a>
    </div>
